...
export default function CloudPrivateWorldApp() {
  const { currentUser, isLoading, logout, messages, settings, notification, dismissNotification } = useCloudApp();
