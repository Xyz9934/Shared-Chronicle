...
const styles = StyleSheet.create({
  ...
  navScroll: { backgroundColor: '#fff', borderTopColor: c.border, borderTopWidth: 1, height: 68 }, nav: { alignItems: 'center', gap: 6, minHeight: 67, paddingHorizontal: 12 }, navItem: { alignItems: 'center', borderRadius: 14, flexDirection: 'column', gap: 2, justifyContent: 'center', minWidth: 58, paddingHorizontal: 9, paddingVertical: 5 }, navItemActive: { backgroundColor: c.secondary }, navIcon: { alignItems: 'center', height: 18, justifyContent: 'center', position: 'relative', width: 22 }, navText: { color: c.mutedForeground, fontSize: 10, fontWeight: '700' }, navTextActive: { color: c.primary }, badge: { alignItems: 'center', backgroundColor: c.primary, borderColor: c.background, borderRadius: 8, borderWidth: 2, height: 17, justifyContent: 'center', minWidth: 17, position: 'absolute', right: -10, top: -9 }, badgeText: { color: '#fff', fontSize: 8, fontWeight: '800' },
